...
const Header = () => {
  ...
  return (
    <header className="w-full p-4 text-black dark:text-white z-50 fixed left-0 top-0 bg-white dark:bg-black font-news text-xl shadow-md">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-8 items-center absolute left-1/2 transform -translate-x-1/2">
          <h5 className="nav-link" onClick={() => navigate("/")}>Home</h5>
          <h5 className="nav-link" onClick={() => scrollToSection("popular")}>Popular</h5>
          <h5 className="nav-link" onClick={() => scrollToSection("works")}>Works</h5>
